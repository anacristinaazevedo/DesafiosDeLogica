/*
A empresa "DIO Bank" precisa receber os dados de uma conta bancária por um objeto JSON e imprimir na
 tela as seguintes informações: o nome do cliente, o número da conta e o saldo. 
...
Saída
Deverá retornar uma mensagem (string) que informa o nome do cliente, o número da conta e o saldo final,
 da seguinte maneira:
...
let contaBancaria = {
    ...
    // Agora crie as demais propriedades numeroConta e saldoInicial:
    numeroConta: gets(),
