/*Desafio
O objetivo deste desafio é criar um programa em JavaScript que compare duas contas bancárias e 
determine se elas possuem ou não as mesmas informações. O programa deve criar dois objetos JSON 
contendo o número da conta e o saldo da conta.
...
// Crie o objeto JSON do Cliente 1 e suas propriedades (nome, conta, saldo):
const cliente1 = {
    nome: gets(),
    conta: parseInt(gets()),
  ...
  // Crie o objeto JSON do Cliente 2 e suas propriedades (nome, conta, saldo):
  const cliente2 = {
    nome: gets(),
    conta: parseInt(gets()),
    saldo: parseFloat(gets())
